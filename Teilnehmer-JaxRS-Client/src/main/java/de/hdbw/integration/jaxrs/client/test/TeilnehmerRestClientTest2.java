...
import de.hdbw.integration.jaxrs.client.TeilnehmerJaxRSClient2;
import de.hdbw.integration.jaxrs.client.TeilnehmerClient;


public class TeilnehmerRestClientTest2 {

	Client client = ClientBuilder.newClient();
	
	String getUrl  		= "http://localhost:8080/Teilnehmer-JaxRS-Service/rest/teilnehmer/1/lesen";
	...
	public void getRequest(){
		...
		String resultJsonString = TeilnehmerJaxRSClient2.getRequest(getUrl, null);
...
//		
//		String resultJsonString = TeilnehmerJaxRSClient2.postRequest(postUrl, inputJSon);
//
...
//
//		String resultString = TeilnehmerJaxRSClient2.putRequest(putUrl, inputJSon);
//
...
//
//		String resultJsonString = TeilnehmerJaxRSClient2.getRequest(getUrlSuchen, null);
...
//	}
	...
	public static void main(String[] args) {
		TeilnehmerRestClientTest2 restClient = new TeilnehmerRestClientTest2();
